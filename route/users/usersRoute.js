...
const userBlock = require('../../middlewares/auth/isBlocked')
const {role} = require('../../controllers/admin/admin')
const {reward} = require('../../helper/reward')
const {rep} = require('../../helper/Rep')
...
userRoutes.put("/rep", authMiddleware, rep);

userRoutes.get("/", authMiddleware, role('Admin'), fetchUsersCtrl);
// Password reset
